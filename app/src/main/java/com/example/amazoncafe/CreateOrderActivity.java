package com.example.amazoncafe;
...
public class CreateOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.hasExtra("name") && intent.hasExtra("password")) {
            ...
            name = getString(R.string.defaolt_name);
            password = getString(R.string.default_password);
        }

        drink = getString(R.string.radiobutton_tea);

        textViewWelcome = findViewById(R.id.textViewWelcome);
        String welcome = String.format(getString(R.string.hello_user), name);
        textViewWelcome.setText(welcome);

        textViewAdditions = findViewById(R.id.textViewAdditions);
        String additions = String.format(getString(R.string.textview_choose_drink), drink);
    ...
    public void onClickChangeDrink(View view) {
        ...
        if (id == R.id.radioButtonTea) {
            ...
            drink = getString(R.string.radiobutton_coffee);
    ...
    public void onClickSendOrder(View view) {
        ...
        if (checkBoxLemon.isChecked() && drink.equals(getString(R.string.radiobutton_tea))) {
            builderAdditions.append(getString(R.string.checkbox_lemon)).append(" ");
        }
        String optionOfDrink = "";
        if (drink.equals(getString(R.string.radiobutton_tea))) {
